...
export const requireLiveTradingEnabled = (config: BotConfig): void => {
...
export const loadWalletKeypair = (config: BotConfig): Keypair | undefined => {
  if (!config.wallet.walletKeypairPath) return;
