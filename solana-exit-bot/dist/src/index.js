...
import { JupiterQuoteProvider, SimulatedQuoteProvider } from "./execution/QuoteProvider.js";
...
import { HeliusWebSocketAdapter, SolanaWebSocketAdapter } from "./rpc/WebSocketManager.js";
...
const quoteProvider = config.mode === "paper" ? new SimulatedQuoteProvider() : new JupiterQuoteProvider(config.market.quoteApiUrl);
...
wsProvider.on("marketEvent", (event) => {
